...
class Answer
{
    /**
     * @var Question
     * @ORM\ManyToOne(targetEntity="Victoire\Widget\PollBundle\Entity\Question", inversedBy="answers")
     */
    private $question;
     ...
     * @return Answer
     */
    public function setQuestion(\Victoire\Widget\PollBundle\Entity\Question $question = null)
    {
     ...
     * Get question
     *
     * @return \Victoire\Widget\PollBundle\Entity\Question
     */
